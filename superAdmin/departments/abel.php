...
<div class="card card-outline card-primary mt-4" id="load-content">
	<div class="card-header d-flex justify-content-between">
		<h3 class="card-title">ABEL Leave Reports</h3>
        <div class="card-tools">
            <button class="btn btn-flat btn-primary" onclick="exportPDF()">Download PDF</button>  
			<a href="#" onclick="loadContent('most_leaves/abel.php')" class="btn btn-flat btn-primary"><span class="fas fa-user"></span>  Most Leaves</a>
		</div>
			...
			<table id="tableData" class="table table-striped">
				...
				<tbody>
                        <?php
                            ...
                            WHERE employee.department = 1 AND (employee_leave.status = 'Accepted' OR employee_leave.status = 'Rejected')"
                            );
...
<script>
    ...
    function exportPDF() {
        window.location.href = '../ajax/super_admin/export_abel.php';
    }
