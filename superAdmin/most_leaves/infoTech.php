...
<div class="card card-outline card-primary mt-4" id="load-content">
	<div class="card-header d-flex justify-content-between">
		<h3 class="card-title">Information Technology Most Leaves</h3>
			...
			<table id="tableData" class="table table-striped">
				...
				<tbody>
                        <?php
                            ...
                            WHERE employee.department = 6 AND employee_leave.status = 'Accepted'
...
<script>
    ...
    function exportPDF() {
        window.location.href = '../ajax/super_admin/most_leaves/export_infoTech.php';
    }
